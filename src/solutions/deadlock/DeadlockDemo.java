...
public class DeadlockDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread t1 = new Thread(new SyncThread(ob1, ob2, semaforoBinario), "Thread-1");
        Thread t2 = new Thread(new SyncThread(ob2, ob1,semaforoBinario), "Thread-2");
        Thread t3 = new Thread(new SyncThread(ob3, ob1, semaforoBinario), "Thread-3");
...
class SyncThread implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("Error en el semaforo");
        }
